...
return [
    ...
    'description' => 'Token-authenticated REST API consumed by the StockBeat mobile app (React Native).',
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtain a token via `POST /auth/otp/request` then `POST /auth/otp/verify` (Laravel Sanctum bearer token).',
    ],
    ...
    'strategies' => [
        ...
        // ResponseCalls (live HTTP calls against real routes) removed: every endpoint here requires
        // team/auth state that isn't safe to fabricate at doc-generation time. Responses are documented
        // via explicit @response annotations on each controller method instead.
