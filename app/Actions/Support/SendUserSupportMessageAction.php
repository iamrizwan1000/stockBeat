 ...
 * messages — keyed by user+the exact message body, so sending a genuinely
 * different follow-up moments later is never blocked.
 */
class SendUserSupportMessageAction
{
    ...
    {
        return IdempotencyGuard::once('support-message:'.$user->id.':'.md5($body), 15, function () use ($user, $body) {
