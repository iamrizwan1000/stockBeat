...
class UpdateRuleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'trigger' => ['sometimes', 'string', ValidationRule::in(Rule::triggers())],
            ...
            'actions.*.type' => ['required_with:actions', 'string', ValidationRule::in([
            ...
            'priority' => ['sometimes', 'string', ValidationRule::in(Rule::priorities())],
            ...
            'controls.digest_frequency' => ['sometimes', 'string', ValidationRule::in(['daily', 'weekly', 'monthly'])],
            'controls.digest_time' => ['sometimes', 'date_format:H:i'],
            'controls.digest_day_of_week' => ['sometimes', 'integer', 'between:0,6'],
            'controls.digest_day_of_month' => ['sometimes', 'integer', 'between:1,28'],
            ...
            'controls.positive_review_min_rating' => ['sometimes', 'integer', 'between:1,5'],
            'controls.review_keyword' => ['sometimes', 'nullable', 'string', 'max:100'],
            'controls.stale_days' => ['sometimes', 'integer', 'min:1'],
