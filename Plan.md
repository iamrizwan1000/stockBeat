...
`/admin/api/v1` (a separate token-authenticated admin API namespace per §10) still was never built — the admin panel talks to its own Inertia web controllers directly; out of scope for every pass so far.*
